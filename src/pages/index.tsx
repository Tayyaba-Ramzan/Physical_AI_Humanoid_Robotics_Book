      ...
      <div className="container relative z-10 px-4">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-10 leading-relaxed">
              A next-generation learning system for{' '}
              <strong>Physical AI & Humanoid Robotics</strong>.
              Master robotics through adaptive modules,
              real-world engineering workflows,
              and an AI mentor that evolves with you — from
              core foundations to frontier-level research.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-32 text-left">
          ...
          <FadeIn delay={200}>
            <FeatureCard
              icon="💬"
              title="Always-On AI Mentor"
              description="A context-aware AI tutor trained on the full curriculum to guide, explain, debug, and accelerate your robotics learning — 24/7."
            />
          </FadeIn>
          ...
          <FadeIn delay={400}>
            <FeatureCard
              ...
              description="Learn complex robotics concepts comfortably by switching between English and Urdu — without losing technical precision."
            />
          </FadeIn>
        </div>
      </div>
...
export default function Home(): JSX.Element {
  return (
    <Layout title="Home" description="AI-Native Textbook for Physical AI">
      <HomepageHeader />
    </Layout>
  );
}
